...
test_that("logranges have expected length", {
  ...
  expect_equal(length(logrange_1), 61)
  expect_equal(length(logrange_15), 122)
  expect_equal(length(logrange_12357), 305)
  expect_equal(length(logrange_123456789), 549)
  expect_equal(length(logrange_5), 1098)
})
